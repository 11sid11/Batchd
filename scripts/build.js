...
// Entry points outside src/ (just the Chrome content script today) are
// resolved here. Everything else lives in src/.
function sourcePath(filename) {
  if (filename === CHROME_ENTRY) return `extension/${CHROME_ENTRY}`;
  return `src/${filename}`;
}
